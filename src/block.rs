...
impl Block{
    ...
    fn parse_text_block(line_iter : &mut Lines, name : String, length : u32) -> Result<Block, BlockParsingError>{
        let mut content = vec![];
    ...
    fn parse_array_block(line_iter : &mut Lines, name : String, length : u32) -> Result<Block, BlockParsingError>{
        let mut content = vec![];
